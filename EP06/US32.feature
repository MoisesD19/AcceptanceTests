Feature: Formas de comunicación con la empresa
...
And recibo una <confirmación> visible de que mi mensaje fue enviado con éxito.

Examples:
  | nombreApellido | correoElectronico | asunto  | mensaje                    | boton  | confirmacion                |
  | Esteban Quito  | esteban@gmail.com | Soporte | "Tengo un problema con..." | Enviar | "Mensaje enviado con éxito" |
